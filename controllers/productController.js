...
var gateway = new braintree.BraintreeGateway({
  environment: braintree.Environment.Sandbox,
  merchantId: "k8mtd2mndk8s9hxr",
  publicKey: "rhp6fwy7kmsxs2w6",
  privateKey: "297f5f732a508c15873d43288bddbb8e",
});
    ...
    switch (true) {
      ...
      case !photo && photo.size > 2000000:
        return res.status(500).send({
          error: "Photo is required and size should be less than 2 Mb",
        });
    }
...
export const updateProductController = async (req, res) => {
  try {
    ...
    switch (true) {
      ...
      case !category:
        return res.status(500).send({ error: "Category is required" });
      case photo && photo.size > 1200000000:
        return res.status(500).send({
          error: "Photo is required and size should be less than 2 Mb",
        });
    }
